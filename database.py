                ...
                for line in f:
                    ...
                    if collection.count_documents({'_id': key}, limit=1) != 0:
                        ...
                        collection.update({"_id": db_list[0]}, {'$push': {
                            "doc_info": {"uniqueID": db_list[1], "originalID": db_list[2], "frequency": db_list[3][0], 'title': db_list[3][1], 'header': db_list[3][2], 'bold': db_list[3][3], 'body': db_list[3][4]}}})
                        continue
                    else:
                        # Inputs the key into the database if the key doesn't exist
                        post = {"_id": db_list[0], "total": 1, "doc_info": [
                            {"uniqueID": db_list[1], "originalID": db_list[2], "frequency": db_list[3][0], 'title': db_list[3][1], 'header': db_list[3][2], 'bold': db_list[3][3], 'body': db_list[3][4]}]}
